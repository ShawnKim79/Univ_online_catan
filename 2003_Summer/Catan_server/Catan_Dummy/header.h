...
#define WM_SOCKETMESSAGE		(WM_USER + 10)
#define WM_GAMERESULT			(WM_USER + 20)
#define WM_GAMESTATE			(WM_USER + 34)

#define WM_GAMESTART			(WM_USER + 40)
#define WM_GAMEEND				(WM_USER + 42)
#define WM_PLAYCHECK			(WM_USER + 44)
...
enum CURSEND { ANY, ALLUSERS, ALLROOMS };
enum { MAKEROOM = 100, JOINROOM = 200 };

enum { DRAW = 0, VICTORY = 1, LOSS = 2 };
enum { GAMEOVER = 0, INGAME = 1 };
...
// Section #4 : Lobby와 game.exe 과의 메세징.
// default 선언은 LGM_...
/*
////////////////////////////////////////////////////////////////////////////////
// 0x0700 ~ 0x07ff : Lobby Client -> game.exe
#define LGM_GAMESTART	0x0700
#define LGM_LIVECHECK	0x0701

// default 선언은 GLM_...
////////////////////////////////////////////////////////////////////////////////
// 0x0800 ~ 0x08ff : game.exe -> Lobby Client
#define GLM_INLIVE		0x0800
#define GLM_GAMEEND		0x0801
#define GLM_GAMESTATU	0x0802
*/
