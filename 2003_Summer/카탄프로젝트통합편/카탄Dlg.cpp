...
BEGIN_MESSAGE_MAP(CMyDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_SERVER_BTN, OnServerBtn)
	ON_BN_CLICKED(IDC_CLIENT_BTN, OnClientBtn)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
