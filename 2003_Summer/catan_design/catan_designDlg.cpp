...
void CCatan_designDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_PLAYERLIST, m_ctrlList); // ListBox 객체를 실제로 다이얼로그 윈도우에 표시 해준다.
	                                              // 단순한 변수 연결만을 하는 것이 아니다!
	//}}AFX_DATA_MAP
}
...
void CCatan_designDlg::InsertColumn()
{
	...
	m_ctrlList.InsertColumn(0, "플레이어", LVCFMT_CENTER, 60);
	m_ctrlList.InsertColumn(1, "카드갯수", LVCFMT_CENTER, 60);
